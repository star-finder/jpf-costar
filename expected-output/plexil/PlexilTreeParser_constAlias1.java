...
public class PlexilTreeParser_constAlias1 extends TestJPF {

	@Test
	public void test_constAlias0() throws Exception {
		...
		obj.constAlias(_t,parent);
	}


	@Test
	public void test_constAlias1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
