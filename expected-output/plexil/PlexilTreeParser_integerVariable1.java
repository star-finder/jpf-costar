...
public class PlexilTreeParser_integerVariable1 extends TestJPF {

	@Test
	public void test_integerVariable0() throws Exception {
		...
		obj.integerVariable(_t,parent);
	}


	@Test
	public void test_integerVariable1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		...
		plexil.PlexilASTNode integerVariable_AST_in_3 = _t_1;
	...
	@Test
	public void test_integerVariable2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		plexil.PlexilASTNode _t = new plexil.PlexilASTNode();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
