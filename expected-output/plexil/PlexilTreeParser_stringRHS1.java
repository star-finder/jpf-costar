...
public class PlexilTreeParser_stringRHS1 extends TestJPF {

	@Test
	public void test_stringRHS0() throws Exception {
		...
		obj.stringRHS(_t,parent);
	}


	@Test
	public void test_stringRHS1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_stringRHS2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
