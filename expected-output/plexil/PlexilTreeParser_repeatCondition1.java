...
public class PlexilTreeParser_repeatCondition1 extends TestJPF {

	@Test
	public void test_repeatCondition1() throws Exception {
		...
		net.n3.nanoxml.IXMLElement node = null;
		_t.ttype = ttype_1;
		_t.down = down_2;
		_t.right = right_3;
		obj.repeatCondition(_t,node);
	}
