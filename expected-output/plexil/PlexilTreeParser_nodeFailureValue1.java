...
public class PlexilTreeParser_nodeFailureValue1 extends TestJPF {

	@Test
	public void test_nodeFailureValue0() throws Exception {
		...
		obj.nodeFailureValue(_t,parent);
	}


	@Test
	public void test_nodeFailureValue1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_nodeFailureValue2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
