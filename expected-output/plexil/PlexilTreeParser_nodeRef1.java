...
public class PlexilTreeParser_nodeRef1 extends TestJPF {

	@Test
	public void test_nodeRef0() throws Exception {
		...
		obj.nodeRef(_t,parent);
	}


	@Test
	public void test_nodeRef1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
