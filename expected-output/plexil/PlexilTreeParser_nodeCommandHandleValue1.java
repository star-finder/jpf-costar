...
public class PlexilTreeParser_nodeCommandHandleValue1 extends TestJPF {

	@Test
	public void test_nodeCommandHandleValue0() throws Exception {
		...
		obj.nodeCommandHandleValue(_t,parent);
	}


	@Test
	public void test_nodeCommandHandleValue1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_nodeCommandHandleValue2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
