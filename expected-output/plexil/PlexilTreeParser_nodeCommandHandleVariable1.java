...
public class PlexilTreeParser_nodeCommandHandleVariable1 extends TestJPF {

	@Test
	public void test_nodeCommandHandleVariable0() throws Exception {
		...
		obj.nodeCommandHandleVariable(_t,parent);
	}


	@Test
	public void test_nodeCommandHandleVariable1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
