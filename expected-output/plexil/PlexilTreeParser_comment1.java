...
public class PlexilTreeParser_comment1 extends TestJPF {

	@Test
	public void test_comment0() throws Exception {
		...
		obj.comment(_t,parent);
	}


	@Test
	public void test_comment1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
