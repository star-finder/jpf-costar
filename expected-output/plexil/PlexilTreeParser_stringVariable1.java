...
public class PlexilTreeParser_stringVariable1 extends TestJPF {

	@Test
	public void test_stringVariable0() throws Exception {
		...
		obj.stringVariable(_t,parent);
	}


	@Test
	public void test_stringVariable1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		...
		plexil.PlexilASTNode stringVariable_AST_in_3 = _t_1;
	...
	@Test
	public void test_stringVariable2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		plexil.PlexilASTNode _t = new plexil.PlexilASTNode();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
