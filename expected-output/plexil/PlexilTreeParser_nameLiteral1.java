...
public class PlexilTreeParser_nameLiteral1 extends TestJPF {

	@Test
	public void test_nameLiteral0() throws Exception {
		...
		obj.nameLiteral(_t,parent);
	}


	@Test
	public void test_nameLiteral1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
