...
public class PlexilTreeParser_nameExp1 extends TestJPF {

	@Test
	public void test_nameExp0() throws Exception {
		...
		obj.nameExp(_t,parent);
	}


	@Test
	public void test_nameExp1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_nameExp2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
