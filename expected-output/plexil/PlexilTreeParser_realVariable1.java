...
public class PlexilTreeParser_realVariable1 extends TestJPF {

	@Test
	public void test_realVariable0() throws Exception {
		...
		obj.realVariable(_t,parent);
	}


	@Test
	public void test_realVariable1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_realVariable2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		plexil.PlexilASTNode _t = new plexil.PlexilASTNode();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
		...
		plexil.PlexilASTNode realVariable_AST_in_3 = _t_1;
