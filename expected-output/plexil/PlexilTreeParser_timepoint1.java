...
public class PlexilTreeParser_timepoint1 extends TestJPF {

	@Test
	public void test_timepoint0() throws Exception {
		...
		obj.timepoint(_t,parent);
	}


	@Test
	public void test_timepoint1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_timepoint2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
