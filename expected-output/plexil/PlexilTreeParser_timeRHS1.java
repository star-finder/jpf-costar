...
public class PlexilTreeParser_timeRHS1 extends TestJPF {

	@Test
	public void test_timeRHS0() throws Exception {
		...
		obj.timeRHS(_t,parent);
	}


	@Test
	public void test_timeRHS1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_timeRHS2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
