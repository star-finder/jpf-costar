...
public class PlexilTreeParser_varAlias1 extends TestJPF {

	@Test
	public void test_varAlias0() throws Exception {
		...
		obj.varAlias(_t,parent);
	}


	@Test
	public void test_varAlias1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
