...
public class PlexilTreeParser_timeVariable1 extends TestJPF {

	@Test
	public void test_timeVariable0() throws Exception {
		...
		obj.timeVariable(_t,parent);
	}


	@Test
	public void test_timeVariable1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		...
		plexil.PlexilASTNode timeVariable_AST_in_3 = _t_1;
	...
	@Test
	public void test_timeVariable2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		plexil.PlexilASTNode _t = new plexil.PlexilASTNode();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
