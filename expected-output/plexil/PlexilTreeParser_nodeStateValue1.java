...
public class PlexilTreeParser_nodeStateValue1 extends TestJPF {

	@Test
	public void test_nodeStateValue0() throws Exception {
		...
		obj.nodeStateValue(_t,parent);
	}


	@Test
	public void test_nodeStateValue1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
	...
	@Test
	public void test_nodeStateValue2() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
		obj.ASTNULL = new antlr.ASTNULLType();
		net.n3.nanoxml.XMLElement parent = new net.n3.nanoxml.XMLElement();
