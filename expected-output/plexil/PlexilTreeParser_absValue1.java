...
public class PlexilTreeParser_absValue1 extends TestJPF {

	@Test
	public void test_absValue0() throws Exception {
		...
		obj.absValue(_t,parent);
	}


	@Test
	public void test_absValue1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
