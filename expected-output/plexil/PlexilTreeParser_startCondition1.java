...
public class PlexilTreeParser_startCondition1 extends TestJPF {

	@Test
	public void test_startCondition0() throws Exception {
		...
		obj.startCondition(_t,node);
	}


	@Test
	public void test_startCondition1() throws Exception {
		PlexilTreeParser obj = new PlexilTreeParser();
