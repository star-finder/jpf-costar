...
public class Input_withAbs1 extends TestJPF {
	...
	@Test
	public void test_withAbs1() throws Exception {
		Input obj = new Input();
	...
	@Test
	public void test_withAbs2() throws Exception {
		Input obj = new Input();
		random.sll.Node root = new random.sll.Node();
	...
	@Test
	public void test_withAbs3() throws Exception {
		Input obj = new Input();
		random.sll.Node root = new random.sll.Node();
		random.sll.Node next_2 = new random.sll.Node();
		random.sll.Node next_4 = new random.sll.Node();
	...
	@Test
	public void test_withAbs4() throws Exception {
		Input obj = new Input();
		random.sll.Node root = new random.sll.Node();
		random.sll.Node next_2 = new random.sll.Node();
